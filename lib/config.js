...
export const normalizedPrice = ({ priceMin, priceMax, priceExact }) => {
  ...
  if (isNaN(priceMin) || isNaN(priceMax) || isNaN(priceExact)) {
    throw createHttpError(400, '400 BAD REQUEST | ERROR in URL: PRICE query param should match <number>-<number> pattern')
  }
